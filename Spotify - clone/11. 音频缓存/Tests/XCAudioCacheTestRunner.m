...
+ (void)showTestMenuFromViewController:(UIViewController *)viewController {
    ...
    // Phase 7 测试
    [alert addAction:[UIAlertAction actionWithTitle:@"运行 Phase 7 测试 (预加载机制)"
                                              style:UIAlertActionStyleDefault
                                            handler:^(UIAlertAction *action) {
        [self runPhase7Test];
    }]];
    ...
    // Phase 8 测试
    [alert addAction:[UIAlertAction actionWithTitle:@"运行 Phase 8 测试 (系统集成)"
                                              style:UIAlertActionStyleDefault
                                            handler:^(UIAlertAction *action) {
        [self runPhase8Test];
    }]];
...
+ (void)runPhase7Test {
    NSLog(@"\n>>> 开始 Phase 7 测试...");
    [XCAudioCachePhase7Test runAllTests];
    NSLog(@"<<< Phase 7 测试结束\n");
}
